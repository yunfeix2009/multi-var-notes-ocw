...
#theorem[
  For a closed, counterclockwise curve $c$ that encloses a region $R$, fix a vector field $vb(F) = (M, N)$, then the work $ integral.cont_c vb(F) dot vb(r) = integral.double_R op("curl") (vb(F)) dif A = integral.double_R . $
