...
#solution[
  ...
  Let $f(alpha, beta, gamma)$ denote the sum of the area of the side triangles. Then, we have $ & f(alpha, beta, gamma) = 1/2(a sqrt(h^2 + alpha^2) + b sqrt(h^2 + beta^2) + c sqrt(h^2 + gamma^2)) \
  & ==> nabla f = ((a alpha)/(2 sqrt(h^2 + a^2)), (b beta) /(2 sqrt(h^2 + beta^2)), (c gamma)/(2 sqrt(h^2 + gamma^2))) \
  & . $
