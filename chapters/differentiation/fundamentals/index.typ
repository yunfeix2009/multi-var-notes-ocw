...
To quantify the change of the growth 121of the function in $x$ and $y$ directions, we make the following definitions inspired by the one-dimensional differentiation: 
