...
#proof[
  We invoke the two dimensional Taylor's approximation (which could be obtained by considering the one variable case then use chain rule): $ Delta f & approx f_x (x- x_0) + f_y (y-y_0) \ & quad""+ 1/2 f_(x x) (x- x_0)^2 + f_(x y ) (x-x_0) (y-y_0)+ 1/2 f_(y y) (y-y_0)^2 . $
