...
Thus, if $ z=1-x^2 - y^2 = 1-r^2, R:={(x, y): 0<=x, y<=1} = {(r, theta): r in [0, 1] and theta in [0, pi/2], $ $ integral.double_R z dif x dif y &= integral_0^(pi/2) integral_0^1 (1-r^2) r dif r dif theta
\ &= integral_0^(pi/2) (r^2/2 - r^4/4) |_0^1 dif theta
