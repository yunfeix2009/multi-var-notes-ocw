...
#lbl(<def:integration-double-integrals-1>, definition[
...
#lbl(<rem:integration-double-integrals-1>, remark[
...
#lbl(<ex:integration-double-integrals-2>, example[
...
#solution[
  ...
  Therefore, $ 2/3 integral_0^(1) sqrt(1-x^2)^(3/2) & = 2/3 integral_0^(pi/2) cos theta^3 cos theta dif theta \
...
#lbl(<rem:integration-double-integrals-2>, remark[
...
#lbl(<ex:integration-double-integrals-3>, example[
...
#lbl(<rem:integration-double-integrals-3>, remark[
  $pi$!
