...
#solution[
  ...
  \ &= integral_(-sqrt(2))^sqrt(2) 8/3 root(3, 2-x^2) dif x,
  $ which could be solved with trig substitution. But if an integral requires trig substitution, it could almost always be done in terms of polar coordinates by exploiting the symmetry. In this case, 
