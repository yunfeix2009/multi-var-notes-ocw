...
+ One of the most frequent applications of dot product is converting between lengths and angles and coordinates.
  ...
  #lbl(<ex:dot-product-angle-1>, example[
  ...
  #lbl(<ex:preliminaries-dot-product-applications-2>, example[Pset 1 Part II p1][
...
+ Dot product is pivotal in dealing with surfaces.
  #lbl(<ex:dot-product-angle-2>, example[
  ...
  #lbl(<cor:preliminaries-dot-product-applications-1>, corollary[
  ...
  #lbl(<thm:preliminaries-dot-product-applications-1>, theorem[
...
#lbl(<rem:preliminaries-dot-product-applications-1>, remark[
