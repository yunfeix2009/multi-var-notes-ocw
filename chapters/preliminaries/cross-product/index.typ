...
#lbl(<thm:preliminaries-cross-product-1>, theorem[
...
#lbl(<rem:preliminaries-cross-product-1>, remark[
...
#lbl(<thm:preliminaries-cross-product-2>, theorem[
...
#lbl(<thm:preliminaries-cross-product-3>, theorem[
...
#lbl(<thm:lagrange-identity>, theorem[Lagrange Identity (two variables)][
...
#lbl(<rem:preliminaries-cross-product-2>, remark[
  In fact, this theorem is generalizable to finitely many vectors.
])


#lbl(<ex:preliminaries-cross-product-1>, example[Pset2 PartII P1][
...
#lbl(<ex:preliminaries-cross-product-2>, example[Pset2 PartII P3][
...
#lbl(<ex:preliminaries-cross-product-3>, example[
