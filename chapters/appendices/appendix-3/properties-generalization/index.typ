...
+ Convergent Sequences
  #lbl(<def:appendices-appendix-3-properties-generalization-1>, definition[
  ...
  #lbl(<rem:appendices-appendix-3-properties-generalization-1>, remark[
    In here, we generalized the absolute value in the classic real analysis definition to $d$.
  ])
+ Cauchy Sequences
  #lbl(<def:appendices-appendix-3-properties-generalization-2>, definition[
  ...
  #lbl(<rem:appendices-appendix-3-properties-generalization-2>, remark[
...
+ Open Set
  ...
  #lbl(<def:appendices-appendix-3-properties-generalization-3>, definition[
  ...
  #lbl(<def:appendices-appendix-3-properties-generalization-4>, definition[
    A set $A$ is open iff $ forall a in A,quad exists epsilon in RR^+ : B_epsilon (a) subset.eq A. $
  ])
+ Continuous Functions
  #lbl(<def:appendices-appendix-3-properties-generalization-5>, definition[
  ...
  #lbl(<rem:appendices-appendix-3-properties-generalization-3>, remark[
    In here, we similarly generalized the absolute value in the classic real analysis definition to $d$.
  ])

#lbl(<def:appendices-appendix-3-properties-generalization-6>, definition[
  $C^0 ([a, b]):=$ the set of all continuous functions that maps $[a, b] |-> RR$.
])
#lbl(<emp:metric-onC>, example[
...
#lbl(<def:appendices-appendix-3-properties-generalization-7>, definition[
  $C^n ([a, b]):=$ the set of all n-th continuously differentiable functions that maps $[a, b] |-> RR$.
])
#lbl(<ex:appendices-appendix-3-properties-generalization-2>, example[
...
#lbl(<thm:appendices-appendix-3-properties-generalization-1>, theorem[
...
#lbl(<ex:appendices-appendix-3-properties-generalization-3>, example[
...
#lbl(<rem:appendices-appendix-3-properties-generalization-4>, remark[
...
#lbl(<ex:appendices-appendix-3-properties-generalization-4>, example[
